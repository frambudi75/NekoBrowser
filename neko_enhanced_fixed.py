...
def index():
    html = (
        ...
        f"<p>Running: {is_browser_running()}</p>"
        f"<p>URL: {settings.get('URL')}</p>"
...
def config():
    ...
    <form method="POST">
      URL: <input type="text" name="url" value="{settings.get('URL')}"><br>
      Refresh Time (detik): <input type="text" name="refresh_time" value="{settings.get('Refresh_Time')}"><br>
      Telegram Token: <input type="text" name="telegram_token" value="{telegram_config.get('Telegram_Token')}"><br>
      Telegram Chat ID: <input type="text" name="telegram_chat" value="{telegram_config.get('Telegram_Chat_ID')}"><br>
